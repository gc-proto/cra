...
var toolbar = {
	...
	dictionary : {
		 homePage :(PE.language == "eng") ? "InfoZone" : "InfoZone",
	     topOfPage :(PE.language == "eng") ? "Top of Page" : "Haut de la page",
		 searchLabel :(PE.language == "eng") ? "Search InfoZone:" : "Recherche sur InfoZone : ",
	...
	init : function(){
		...
		if($(this).scrollTop() < 10 || $(this).scrollTop() == undefined) $(".toolbar").hide().attr('aria-hidden','true');
		else $(".toolbar").attr('aria-hidden','false');
	},
