...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			rowFilter: ' ',
			colFilter: ' ',
			colors: ['#c00','#cc0','#726d00','#00556b','#fc0','#8c104e','#5a5136','#bdd8de','#0ff'],
		...
		canvasContain.addClass('visualize').attr('role', 'img').attr('aria-label', 'Chart representing data from the table: ' + title)
