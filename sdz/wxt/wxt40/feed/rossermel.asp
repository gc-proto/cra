...
const TWEETS_CACHE_KEY = 		"RossErmelAC_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"RossErmelAC_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("RossErmelAC", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/images-common/twitter-ross_ermel.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
