...
const TWEETS_CACHE_KEY = 		"PSGives_SPDonne_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"PSGives_SPDonne_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("PSGives_SPDonne", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-psgives.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
