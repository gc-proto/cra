...
const TWEETS_CACHE_KEY = 		"CRAMGN_RMGARC_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"CRAMGN_RMGARC_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("CRAMGN_RMGARC", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-cramgn_rmgarc.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
