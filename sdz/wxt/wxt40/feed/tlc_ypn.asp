...
const TWEETS_CACHE_KEY = 		"@ARYPN_RJPRA_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@ARYPN_RJPRA_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@ARYPN_RJPRA", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-tlc_ypn.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
