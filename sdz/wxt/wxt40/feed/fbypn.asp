...
const TWEETS_CACHE_KEY = 		"@FABYPN_RJPDGFA_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@FABYPN_RJPDGFA_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@FABYPN_RJPDGFA", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/images-common/twitter-fbypn.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
