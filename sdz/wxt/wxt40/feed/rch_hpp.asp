...
const TWEETS_CACHE_KEY = 		"@Rock_CFO_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@Rock_CFO_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@Rock_CFO", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-rochhuppe.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
