...
$(function () {
    ...
    if (commentDiv.length !== 0) {
        $.getScript("https://pab-dgap-lse-esl.isvcs.net/dialogue/static/dialogue.js")
        .done(function() {
            callcomments(commentDiv);
        })
        ...
        $("body").append("<script type=\"text/javascript\" src=\"https://pab-dgap-lse-esl.isvcs.net/dialogue/static/dialogue.js\"></script>\n");
    }
    ...
    if (iceListEdit.length > 0) {
        ...
        $.getScript("https://pab-dgap-lse-esl.isvcs.net/static/listedit/js/ice-listedit.js")
            .done(function() {
                console.log("ICE list editor Javascript loaded.");
            })
            .fail(function( jqxhr, settings, exception ) {
                console.log("ICE list editor Javascript not loaded.");
            });
