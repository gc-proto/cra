...
const TWEETS_CACHE_KEY = 		"@CathyHawara_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@CathyHawara_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@CathyHawara", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-cathyhawara.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
