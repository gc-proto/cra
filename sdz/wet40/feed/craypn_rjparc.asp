...
const TWEETS_CACHE_KEY = 		"@craypn_rjparc_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@craypn_rjparc_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@craypn_rjparc", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-craypn_rjparc.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
