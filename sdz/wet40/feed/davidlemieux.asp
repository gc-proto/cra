...
const TWEETS_CACHE_KEY = 		"Davidlemieux15_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"Davidlemieux15_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("Davidlemieux15", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-dancouture.png);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
