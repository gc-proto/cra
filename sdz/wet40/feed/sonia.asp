...
const TWEETS_CACHE_KEY = 		"@Sonia__Cote_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@Sonia__Cote_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("Sonia__Cote", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-nn_mr_hm.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
