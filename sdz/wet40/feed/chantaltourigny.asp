...
const TWEETS_CACHE_KEY = 		"TourignyChantal_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"TourignyChantal_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("TourignyChantal", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-chntl_trgn.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
