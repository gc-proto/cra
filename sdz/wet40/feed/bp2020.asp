...
const TWEETS_CACHE_KEY = 		"BlueprintGC2020_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"BlueprintGC2020_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("BlueprintGC2020", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-bp2020.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
