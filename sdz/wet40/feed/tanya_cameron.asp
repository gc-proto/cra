...
const TWEETS_CACHE_KEY = 		"@cra_pei_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@cra_pei_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@cra_pei", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/images-common/twitter-tanya_cameron.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
