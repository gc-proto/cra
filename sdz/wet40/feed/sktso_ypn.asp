...
const TWEETS_CACHE_KEY = 		"SKTSO_YPN_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"SKTSO_YPN_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("SKTSO_YPN", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-SKTSO_YPN.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
