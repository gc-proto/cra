...
const TWEETS_CACHE_KEY = 	"SilvanoTocchi_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"SilvanoTocchi_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("SilvanoTocchi", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-silvano-tocchi.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
