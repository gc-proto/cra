...
const TWEETS_CACHE_KEY = 		"@FrancoisDufault_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@FrancoisDufault_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@FrancoisDufault", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/images-common/twitter-francoisdufault.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
