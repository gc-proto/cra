...
const TWEETS_CACHE_KEY = 		"mireille_cra_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"mireille_cra_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("mireille_cra", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/images-common/twitter-mireille_laroche.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
