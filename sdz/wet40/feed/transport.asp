...
const TWEETS_CACHE_KEY = 	"Transport_gc_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"Transport_gc_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("Transport_gc", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-transport.png);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
