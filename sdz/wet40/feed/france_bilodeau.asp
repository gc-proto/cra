...
const TWEETS_CACHE_KEY = 		"FranceBilodeau1_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"FranceBilodeau1_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("FranceBilodeau1", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-france_bilodeau.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
