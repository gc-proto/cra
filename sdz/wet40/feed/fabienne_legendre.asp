...
const TWEETS_CACHE_KEY = 		"@faboutaouais_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@faboutaouais_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@faboutaouais", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-fabienne_legendre.png);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
