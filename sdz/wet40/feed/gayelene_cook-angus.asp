...
const TWEETS_CACHE_KEY = 		"@cra_stc_pei_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@cra_stc_pei_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@cra_stc_pei", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-gayelene_cook_angus.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
