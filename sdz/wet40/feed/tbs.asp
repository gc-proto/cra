...
const TWEETS_CACHE_KEY = 	"TBS_Canada_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"TBS_Canada_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("TBS_Canada", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-tbs.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
