...
const TWEETS_CACHE_KEY = 		"@kath_canada_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"@kath_canada_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("@kath_canada", 15)
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-kathryn_weston.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
