...
const TWEETS_CACHE_KEY = 	"dicairefrancois_TWEETS_CACHE"
const TWEETS_CACHE_TIMER_KEY = 	"dicairefrancois_TWEETS_CACHE_TIMER"
...
Public Function GetCachedTweetsHTML
	...
	If IsCacheExpired Then
		call TwitterFeed_Load ("dicairefrancois", 15)
...
'	objASPTwitter.strBearerToken = "AAAAAAAAAAAAAAAAAAAAANTX5AAAAAAAcu0EBmhNukz%2Fi98V8W4X%2F9dSFmo%3DLjU7G0HO0rFMx3QkC5gbvQulVaC6DSX9LiQ9q1JgOawtxO2FjR"
...
Function CreateTweetsUserTimelineHTML()
	...
	HTMLContent = HTMLContent & "	ul li:before {background-image: url(/wet40/intranet/images/twitter-francois-dicaire.jpg);}"
	HTMLContent = HTMLContent & "</style>"
	HTMLContent = HTMLContent & "</head>"
